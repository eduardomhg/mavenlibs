    ...
    extends PlexusTestCase
{
        ...
        throws Exception
    {
        ...
        // firmware.sqa.plugins:maven-release-manager:(,2.4) > 1.2-SNAPSHOT
        // firmware.sqa.plugins:maven-release-manager:[2.4,) > 1.3-SNAPSHOT
        ...
        throws Exception
    {
		...
		// updateBranchVersions is set to true, so suggest the next snapshot version
        // firmware.sqa.plugins:maven-release-manager:(,2.4) > 1.2-SNAPSHOT (yes, one step back!)
        // firmware.sqa.plugins:maven-release-manager:[2.4,) > 1.3-SNAPSHOT
        ...
        throws Exception
    {
        ...
        ReleaseDescriptor releaseDescriptor = new ReleaseDescriptor();
        releaseDescriptor.setBranchCreation( true );
        // firmware.sqa.plugins:maven-release-manager:(,2.4) > true
        // firmware.sqa.plugins:maven-release-manager:[2.4,) > false
        releaseDescriptor.setInteractive( false );
        phase.execute( releaseDescriptor, new DefaultReleaseEnvironment(), reactorProjects );
